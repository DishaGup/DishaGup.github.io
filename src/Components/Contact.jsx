...
import {
  Alert, AlertIcon, AlertTitle, AlertDescription, Box, Button, Flex, FormControl, FormLabel, Heading, IconButton, Input, InputGroup, InputLeftElement, Link, Stack, Textarea, Tooltip,
  useClipboard, useColorModeValue, VStack
} from '@chakra-ui/react';
import { BsGithub, BsLinkedin, BsPerson, BsTwitter,BsFillTelephoneFill } from 'react-icons/bs';
import { MdEmail, MdOutlineEmail } from 'react-icons/md';
import Particles, {Particle} from 'react-particles'
const confetti = {
  light: {
...
const CONTACT_RESET = 'CONTACT_RESET'
const reducer = (state, { type, payload }) => {
  switch (type) {
    ...
    case CONTACT_MESSAGE: return {
      ...
      break;
    case CONTACT_RESET: return initialState
      break;
...
const Contact = () => {
  const { hasCopied, onCopy } = useClipboard('guptamansi201@gmail.com');
  const [ state, dispatch ] = useReducer(reducer, initialState)
  const [contactsubmitinfo, setcontactsubmitinfo] = useState([])
  const handlesubmitcontactinfo = () => {

       setcontactsubmitinfo(state)
   // console.log(contactsubmitinfo)
...
*/
  ...
  // console.log(state,dispatch,initialState)
  return (
    <Box w='470px' m='50px auto' bg='#C5CAE9'  h='12cm' borderRadius={'20%'} id='contact' >
<Particles/>
      <Flex w='60%' 
        m={'auto'} bg={useColorModeValue('gray.100', 'gray.900')}
        align="center"
        justify="center"
        css={{
        ...
        <Box
          ...
          <Box>
            <VStack 
              w='70%'
              align='center'
              spacing={{ base: 4, md: 8, lg: 20 }} h='100%' >
              <Heading
                fontSize={{
                  base: '4xl',
                  md: '5xl',
              ...
              <Stack w='full' h='full'
                ...
                >
                  ...
                  <Link href="https://github.com/DishaGup" id='contact-github'>
                    <IconButton
                      aria-label="github"
                      variant="ghost"
                      size="lg"
                  ...
                  <Link href="https://www.linkedin.com/in/disha-gupta-303b971a3/" id='contact-linkedin'>
                    <IconButton
                      aria-label="linkedin"
                      variant="ghost"
                      size="lg"
                ...
                >
                  <VStack spacing={14}   >
                    <FormControl isRequired w='90%' >
                      ...
                      <InputGroup  >
                       { !state.name && <InputLeftElement children={<BsPerson />} boxSize='30px' /> }
                        <Input type="text" _placeholder={{ p: '20px', color: 'gray', fontWeight: '600px', px: '30px' }} value={state.name} name="name" onChange={(e) => dispatch({ type: CONTACT_NAME, payload: e.target.value })} placeholder="Your Name" h='0.8cm' />
                      </InputGroup>
                    </FormControl>
                    ...
                    <FormControl isRequired w='90%'>
                      ...
                      <InputGroup>
                    {!state.email && <InputLeftElement children={<MdOutlineEmail />} boxSize='30px' />  }
                        <Input _placeholder={{ p: '20px', color: 'gray', fontWeight: '600px', px: '30px' }} value={state.email} onChange={(e) => dispatch({ type: CONTACT_EMAIL, payload: e.target.value })}
                          type="email"
                          name="email"
                    ...
                    <FormControl isRequired w='90%'>
                      ...
                      <Textarea m={5} onChange={(e) => dispatch({ type: CONTACT_MESSAGE, payload: e.target.value })}
                        name="message" _placeholder={{ p: '20px', color: 'gray', fontWeight: '600px', px: '30px' }}
                        placeholder="Your Message" value={state.message}
                        rows={6}
                        resize="none" w='98%'
                      />
                    </FormControl>
