...
const { hasCopied, onCopy } = useClipboard('guptamansi201@gmail.com');
  ...
  return (
    <Flex
      ...
      <Box
        borderRadius="lg"
        m={{ base: 5, md: 11, lg: 12 }}
        p={{ base: 5, lg: 11 }}
        color='white'
        >
        <Box>
          <VStack spacing={{ base: 4, md: 8, lg: 11 }}>
            <Heading
              fontSize={{
                base: '3xl',
                md: '4xl',
            ...
            <Stack
              ...
              <Box
                ...
                <VStack m={12} gap={5}> <span   id='contact-email'  style={{fontSize:'16px'}} > <strong>Email:</strong> guptamansi201@gmail.com</span>  
            <span    id='contact-phone' style={{fontSize:'16px'}} ><strong>Phone No:</strong>+91 9084360292</span>
             </VStack>
              </Box>
            </Stack>
          </VStack>
